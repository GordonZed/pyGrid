...
#
# pyGrid uses the Pygame Advanced Graphics Library, by Ian Mallett: www.geometrian.com


class pyGrid:

	def __init__(self, x_cells=13, y_cells=10, cell_w=25, cell_h=25, border_px=4, border_rgb=(204,212,163), off=(191,199,149), on=(40,50,40), radius=0, caption="pyGrid Project"):
		...
		self.screen_width  = (self.width * self.cell_width) + (self.width * self.border_weight) + self.border_weight
		self.screen_height = (self.height * self.cell_height) + (self.height * self.border_weight) + self.border_weight
		self.screen_size   = (self.screen_width,self.screen_height)
		self.screen        = pygame.display.set_mode(self.screen_size)

		self.cells = [] #Cells will be stores as a nested list
		# Nested lists are cumbersome, consider a list of tuples as implemented in the snake example
